...
export default function LoginPage() {
  ...
  return (
    <SiteLayout>
      <div className="flex items-center justify-center bg-gradient-to-br from-[#0f0f1a] via-[#1a1a2e] to-[#0f0f1a] py-12 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-200px)] relative overflow-hidden">
        ...
        <div className="max-w-md w-full space-y-8 relative z-10">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-[#f0f0ff] via-[#e6d9ff] to-[#d4b3ff] bg-clip-text text-transparent">
              DECANT
            </h2>
          ...
          <Card className="glass-effect border-[rgba(200,162,255,0.15)] shadow-lavender-soft backdrop-blur-xl">
            <CardHeader>
